...
<head>
    ...
    @else
        {{-- Production scripts --}}
        <link href="{{ asset('build/assets/app-030d1025.css') }}"  rel="preload" as="style" onload="this.rel='stylesheet'">
        <script src="{{ asset('build/assets/app-24679aa5.js') }}" defer></script>
    @endif
