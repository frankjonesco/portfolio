...
<section id="contact" class="bg-gradient-to-tr bg-white text-black">
    
    <div class="container pt-16">
        <h2 class="text-center title-2 text-black">Contact me</h2>
        <p class="pb-12 text-2xl text-center leading-10 text-gray-500 font-light">Get started right away!<br>I'd be happy to answer any questions you might have.</p>
        ...
        <form id="contactForm" action="/contact/send#contact" method="POST" class="text-center">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
                ...
                <div class="lg:col-span-2">
                    <textarea name="message" placeholder="Message *" rows="4" class="w-full border-0 border-b border-1 border-gray-300 bg-transparent px-3 py-3 text-xl focus:ring-0 focus:border-gray-500 transition-colors ease-in duration-300" style="resize: none;"></textarea>
                    @error('message')    
